...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(@Lazy PersonService personService, JwtRequestFilter jwtRequestFilter) {
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        DaoAuthenticationProvider authProvider = new DaoAuthenticationProvider(personService);
